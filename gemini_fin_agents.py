...
def initialize_agents() -> Agent:
    ...
    web_agent = Agent(
        ...
        model=Gemini(id="gemini-2.0-flash", api_key=gemini_api_key, temperature=0.2, grounding=True, search=False),  # Updated model, grounding, removed search
        tools=[],  # Removed DuckDuckGoTools
...
def main():
    ...
    try:
        global agent_team  # Make agent_team accessible globally for display_stock_chart
